...
add_routes <- with(nodes_coord, lapply(mrtl(routes_ind[keep_routes, ]), function(r) st_linestring(cbind(lon[r], lat[r])))) |> 
...
add_routes |> qsave("data/transport_network/add_routes_network_30km_alpha45_mrEU_fmr15.qs")
add_routes <- qread("data/transport_network/add_routes_network_30km_alpha45_mrEU_fmr15.qs")
...
nrow(add_routes)
if(nrow(add_routes) != 481) stop("File should have 481 rows")
add_routes |> qsave("data/transport_network/add_routes_network_30km_alpha45_mrEU_fmr15_adjusted.qs")
