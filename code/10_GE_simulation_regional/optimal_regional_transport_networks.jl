...
res_nodes |> CSV.write("results/transport_network/GE/regional/nodes_results_$(filename).csv")
...
res_graph |> CSV.write("results/transport_network/GE/regional/edges_results_$(filename).csv")
